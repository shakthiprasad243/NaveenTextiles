...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login attempts with invalid email or wrong password should be rejected with proper error messages, but the success message was unexpectedly found.')

...
async def run_test():
    ...
    try:
        ...
        # -> Enter registered email and password and click the sign-in button
        frame = context.pages[-1]
        ...
        # -> Navigate back to the homepage or login page to retry login or investigate the issue
        ...
        # -> Enter registered email and password, then click the Sign In button to attempt login
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/main/div/div/div[2]/form/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('admin@naveentextiles.com')
        ...
        try:
            ...
            raise AssertionError("Test case failed: The login process did not complete successfully. Either the user was not directed to the dashboard/homepage or the session tokens were not set and maintained as expected.")

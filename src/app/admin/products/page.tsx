                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-dark-500 text-xs truncate md:hidden">{product.category}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-4 px-4 hidden md:table-cell">
                      <span className="text-dark-300">{product.mainCategory}</span>
                      <span className="text-dark-500 text-xs block">{product.category}</span>
                    </td>
                    <td className="py-4 px-4">
